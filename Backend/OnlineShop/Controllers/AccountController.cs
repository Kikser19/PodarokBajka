    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(User user)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                {
                    return BadRequest(new { error = "Please correct the errors and try again." });
                }
                return View(user);
            }
        ...
        public IActionResult Login(LoginViewModel user)
        {
            ...
            if (foundUser == null)
            {
                if (Request.Headers["X-Requested-With"] == "XMLHttpRequest")
                {
                    return Unauthorized(new { error = "Email or Password is not valid!" });
                }
        ...
        public IActionResult RecoveryPassword(RecoveryPasswordViewModel recoveryPassword)
        {
            ...
            SmtpServer.Port = 587;
            SmtpServer.Credentials = new System.Net.NetworkCredential("emailsendertest0055@gmail.com", "afqc oivd ychl dsal");
